...
import { CounterNSAsync } from './counter';
import { DebugElement } from '@angular/core';
import { By } from '@angular/platform-browser';

describe('CounterNSAsync', () => {
  let component: CounterNSAsync;
  let fixture: ComponentFixture<CounterNSAsync>;
  let debugElement: DebugElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CounterNSAsync],
    }).compileComponents();

    fixture = TestBed.createComponent(CounterNSAsync);
